...
AHSEsim Numerics provides basic support for such Mat files with the **AHSEsim.Numerics.Data.Matlab** package,
...
and to read them individually as AHSEsim matrices:

    [lang=csharp]
    using AHSEsim.Numerics.LinearAlgebra;
    using AHSEsim.Numerics.Data.Matlab;
