    ...
    open AHSEsim.Numerics.Statistics
...
We need to reference AHSEsim Numerics and open the statistics namespace:

    [lang=csharp]
    using AHSEsim.Numerics.Statistics;
...
as an exception to most of AHSEsim Numerics, the order k is one-based, meaning
...
(minimum, maximum) of the sample data if available.
  ...
  [hist]: https://numerics.mathdotnet.com/api/AHSEsim.Numerics.Statistics/Histogram.htm
