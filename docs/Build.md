...
Example:
    ...
    //
    // AHSEsim Numerics                    v3.5.0
    // AHSEsim Numerics MKL Provider       v1.7.0
    // AHSEsim Numerics Data Extensions    v3.1.0
...
*   Update Wikipedia release version and date for the
    [AHSEsim Numerics](https://en.wikipedia.org/wiki/Math.NET_Numerics) and
