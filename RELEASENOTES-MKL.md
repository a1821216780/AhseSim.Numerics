...
* Note that AHSEsim.Numerics.Providers.MKL.dll is required for this to work with Numerics v5
...
* r15 with Intel oneAPI 2021.4, preview for Numerics v5 with AHSEsim.Numerics.Pro
* Note that AHSEsim.Numerics.Providers.MKL.dll is required for this to work with Numerics v5
